/*! For license information please see c1a234f6b2c871b3.vendor.js.LICENSE.txt */
    ...
    [25436], {
        44080: (t, e) => {
            ...
            function q(t, e, n) {
                ...
                if (!a) throw new i(`Could not create WebGLTexture for texture with ID: '${e.id}'.`);
            ...
            class tt {
                constructor(t) {
                    this.index = 0, this.buffers = null != t ? t : [new B({
                        colorFormat: "rgba",
                        numberFormat: "u8"
                    }), new B({
                        colorFormat: "rgba",
            ...
            const et = class t {
                static createPingpongBuffers({
                    ...
                    return new tt([Q("A", t, e, n), Q("B", t, e, n)])
                }
                constructor({
                    passes: e,
                    uniforms: n,
                    ...
                    this.enableOneTriangleOptimisation = null != s ? s : t.enableOneTriangleOptimisation, i = null != i ? i : t.createPingpongBuffers(o);
                    const {
                        passes: a,
                        uniforms: u
                    ...
                    const l = this.getRenderTextures(a, o);
                    this.renderables = this.getRenderables(a, l, i, r, o)
                }
                ...
                getRenderTextures(t, e) {
                    ...
                    for (const i of t) {
                        if (i.inputs)
                            for (const t of i.inputs) t !== K ? n.add(t) : console.warn(`Your render pass should not define ${K}. This will be automatically added.`);
                        i.output && n.add(i.output)
                    }
                    const r = new Map;
                    for (const i of n) r.set(i, Q(i, null == e ? void 0 : e.width, null == e ? void 0 : e.height, null == e ? void 0 : e.size));
                    return r
                }
            ...
            et.enableOneTriangleOptimisation = !1;
            let nt, rt, it = et;

            function ot(t, e) {
                if (!(nt && rt || (nt = document.createElement("canvas"), rt = nt.getContext("2d"), rt))) throw new n("Unable to establish `CanvasRenderingContext2D` for debugging");
                return nt.width = t, nt.height = e, {
                    canvas: nt,
                    context: rt
                }
            }
            ...
            const lt = "LkEaxkGQc",
                ...
                Tt = "MpMrqOkTf";
            var At = 1e-6,
                Ot = "undefined" != typeof Float32Array ? Float32Array : Array;

            function xt() {
                var t = new Ot(9);
                return Ot != Float32Array && (t[1] = 0, t[2] = 0, t[3] = 0, t[5] = 0, t[6] = 0, t[7] = 0), t[0] = 1, t[4] = 1, t[8] = 1, t
            }

            function Rt() {
                var t = new Ot(16);
                return Ot != Float32Array && (t[1] = 0, t[2] = 0, t[3] = 0, t[4] = 0, t[6] = 0, t[7] = 0, t[8] = 0, t[9] = 0, t[11] = 0, t[12] = 0, t[13] = 0, t[14] = 0), t[0] = 1, t[5] = 1, t[10] = 1, t[15] = 1, t
            }
            ...
            function Lt() {
                var t = new Ot(3);
                return Ot != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0), t
            }
            ...
            function It() {
                var t = new Ot(4);
                return Ot != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0), t[3] = 1, t
            }
            Lt(),
                function() {
                    var t = function() {
                        var t = new Ot(4);
                        return Ot != Float32Array && (t[0] = 0, t[1] = 0, t[2] = 0, t[3] = 0), t
                    }()
                }();
            ...
            const Ht = {
                ...
                Vt = async t => (await fetch(t)).arrayBuffer(),
                qt = t => (new TextDecoder).decode(t);
            class zt {
                constructor(t, e, n) {
                ...
                async getBufferViewFromAccessor(t) {
                    ...
                    const e = Gt[t.type],
                        n = Ht[t.componentType].BYTES_PER_ELEMENT * e * t.count;
                ...
                async bufferViewData(t, e) {
                    ...
                    const n = this.gltf.bufferViews[t],
                        ...
                        a = r.byteOffset;
                    switch (e) {
                        case Ut.GLTF_BUFFER_TYPE_BYTE:
                            return new Int8Array(s, a + o, i);
                        case Ut.GLTF_BUFFER_TYPE_UNSIGNED_BYTE:
                            return new Uint8Array(s, a + o, i);
                        case Ut.GLTF_BUFFER_TYPE_SHORT:
                            return new Int16Array(s, a + o, i / 2);
                        case Ut.GLTF_BUFFER_TYPE_UNSIGNED_SHORT:
                            return new Uint16Array(s, a + o, i / 2);
                        case Ut.GLTF_BUFFER_TYPE_UNSIGNED_INT:
                            return new Uint32Array(s, a + o, i / 4);
                        case Ut.GLTF_BUFFER_TYPE_FLOAT:
                ...
                async getBufferData(t) {
                    ...
                    })(e.uri) : await Vt(this.baseUrl + e.uri);
                ...
                async getImageData(t) {
                    ...
                    if (void 0 !== e.bufferView) {
                        const t = await this.bufferViewData(e.bufferView, Ut.GLTF_BUFFER_TYPE_BYTE),
                            r = new Blob([t], {
                                type: e.mimeType
                            });
            ...
            const Wt = async t => {
                    ...
                    const n = Xt(e),
                        r = await Kt(e);
                    return new zt(n, r.json, r.chunks)
                },
                Xt = t => {
                    let e = "";
                    try {
                ...
                Kt = async t => {
                    ...
                    try {
                        ...
                        n = t.toString().startsWith("blob") || t.toString().startsWith("http") ? await Vt(t) : t;
                        const e = new DataView(n, 0, 12);
                        r = {
                            magic: qt(new Uint8Array(n, 0, 4)),
                ...
                Yt = "placeholder",
                $t = t => t instanceof Uint16Array ? 5123 : t instanceof Uint32Array ? 5125 : 5121,
                Jt = t => {
                    const e = [];
                    return t.forEach(((t, n) => {
                        var r, i;
                        t.name.toLowerCase().includes(Yt) ? e.push({
                            meshIndex: n,
                            name: t.name
                        }) : null != (r = t.material) && r.name.toLowerCase().includes(Yt) && e.push({
                            meshIndex: n,
                ...
                te = (t, e) => {
                    const n = (t => {
                            ...
                            return t.mesh.forEach(((n, r) => {
                                ...
                                e.push({
                                    ...
                                    material: n.material,
                                    id: r,
                                    renderingContextBase: $t(n.indices)
                                })
                            })), e
                        })(t),
                        r = (t => {
                    ...
                    return {
                        ...
                        placeholder: Jt(n),
                        targets: Qt(t.mesh),
                        transform: t.translation.length > 0 ? St(Rt(), kt(t.translation[0], t.translation[1], t.translation[2])) : Rt(),
                        rotation: t.rotation.length > 0 ? Pt(Rt(), jt(t.rotation[0], t.rotation[1], t.rotation[2], t.rotation[3])) : Rt(),
                        scale: t.scale.length > 0 ? kt(t.scale[0], t.scale[1], t.scale[2]) : kt(1, 1, 1),
                        name: t.name,
                        parrent: e,
            ...
            e.AdditiveBlending = {
                ...
                destination: "one",
                equation: "add"
            }, e.BinaryTexture = j, e.Buffer = E, e.Effect = it, e.ElementsBuffer = w, e.FraglAllocationError = i, e.FraglCompilationError = r, e.FraglError = n, e.FraglInternalError = u, e.FraglPlatformError = s, e.FraglRuntimeError = o, e.FraglValidationError = a, e.GltfParser = class {
                constructor(t) {
                    this.src = t, this.camera = ee(), this.cameraModel = Mt(this.camera), this.nodes = [], this.clips = [], this.model = [], this.images = [], this.textures = [], this.samplers = []
                }
                async parse(t = {}) {
                    return this.model = [], this.asset = await Wt(this.src), this.images = await this.getTextureImages(t.imageFilesToReplace), this.updateTexturesData(), this.camera = ee(), this.nodes = await this.getSubNodes(), this.cameraModel = this.getCameraModel(), this.clips = await this.getClips(), this.model = await this.getModel(), this.updateAnimation(), {
                ...
                constructor(t) {
                    this._renderables = {}, this.projectionMatrix = Rt(), this.viewMatrix = Rt(), this.modelMatrix = Rt(), this.modelViewProjectionMatrix = Rt(), this._renderables = t
                }
                get renderables() {
                ...
                updateAll({
                    ...
                    if (t)
                        for (const e of this.renderables) t.uCameraPosition && (e.uniforms[wt] = t.uCameraPosition), t.uMVPMatrix && (e.uniforms[dt] = t.uMVPMatrix), t.uNormalMatrix && (e.uniforms[Et] = t.uNormalMatrix)
                }
                updateOne({
                    id: t,
                    textures: e
                    ...
                    e && e.uPlaceholderTexture && (n.textures[bt] = e.uPlaceholderTexture)
                }
                ...
                createMVPMatrix(t, e) {
                    Ct(this.projectionMatrix, .4, t, .01, 1e3);
                    const n = kt(0, 0, 0),
                        r = kt(0, 1, 0);
                    return function(t, e, n, r) {
                        var i, o, s, a, u, c, l, f, h, p, d = e[0],
                            ...
                            w = n[1],
                            _ = n[2];
                        Math.abs(d - E) < At && Math.abs(y - w) < At && Math.abs(v - _) < At ? function(t) {
                    ...
                    }(this.viewMatrix, e, n, r), Nt(this.modelViewProjectionMatrix, this.viewMatrix, this.modelMatrix), Nt(this.modelViewProjectionMatrix, this.projectionMatrix, this.modelViewProjectionMatrix), Array.from(this.modelViewProjectionMatrix)
                }
                createNormalMatrix() {
                    const t = xt();
                    return function(t, e) {
                ...
                dispose() {
                    window.removeEventListener("mousedown", this.onMouseDown, !1), window.removeEventListener("mousemove", this.onMouseMove, !1), window.removeEventListener("mouseup", this.onMouseUp, !1)
                }
                updatePosition() {
            ...
            }, e.PingpongBuffers = tt, e.PremultipliedNormalBlending = {
                source: "one",
            ...
            }, e.Shader = C, e.WebGlRenderer = X, e.createWebGlRenderer = function(t, e) {
                var n, r, o;
            ...
            }, e.debugBinaryTexture = ut, e.debugImageTexture = at, e.debugRenderTexture = st, e.debugTexture = function(t, e) {
                e && "render" !== e.textureType ? "image" === e.textureType ? at(e) : ut(e) : st(t, e)
            }, e.getAbsoluteTextureSize = M, e.injectAlphaPremultiplication = $, e.paddedTuple = function(t, e, n) {
                                ...
                                for (d = -1, y = p.length; ++d < y;) {
                                    ...
                                    if ((0, i.K)(v))
                                        if ((0, s.Y)(v.unsubscribe).call(v) === a.T) {
                                            e = !0, t = t || [];
                                            var m = a.T.e;
                                            m instanceof u.B ? t = t.concat(l(m.errors)) : t.push(m)
                                        }
                                }
            ...
            var u = function() {
                ...
                c = function(t) {
                    ...
                    return r.ZT(e, t), e.prototype.compare = function(t, e) {
                        ...
                        var e = t;
                        if (this.keySelector && (e = (0, o.Y)(this.keySelector)(t)) === s.T) return this.destination.error(s.T.e);
                        var n = !1;
                        if (this.hasKey) {
                            if ((n = (0, o.Y)(this.compare)(this.key, e)) === s.T) return this.destination.error(s.T.e)
                        } else this.hasKey = !0;
            ...
            var l = function() {
                ...
                f = function(t) {
                    ...
                    return r.ZT(e, t), e.prototype._next = function(t) {
                        ...
                        r && r.unsubscribe();
                        var i = new o.d(this, void 0, void 0);
                        this.destination.add(i), this.innerSubscription = (0, s.D)(this, t, e, n, i)
                    }, e.prototype._complete = function() {
...
//# sourceMappingURL=sourcemaps/c1a234f6b2c871b3.vendor.js.map