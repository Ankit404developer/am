            ...
            (function(__c) {
                ...
                var S4 = function() {
                    ...
                    rOb = function(a) {
                        var b, c = a.Oz,
                            d = a.content;
                        a = a.context;
                        __c.B("formula" === (null === d || void 0 === d ? void 0 : null === (b = d.tg) || void 0 === b ? void 0 : b.type));
                        b = d.tg.value;
                        switch (b.type) {
                            case "invalid":
                                b = b.Gca;
                    ...
                    qOb = function(a, b, c) {
                        var d;
                        return null === (d = a.bha) || void 0 === d ? void 0 : d.call(a, {
                            context: b,
                            value: c
                        })
                    },
                        ...
                        const a = new yOb,
                            ...
                            d = Y4(f => {
                                const {
                                    ...
                                    size: k,
                                    tqa: h
                                }), [k, h]), q = h ? Math.max(g, h) : g, r = Z4(v => null != m && a.pua(m).has(v), [m]), t = Z4(v => null != m && a.I6a(l, m).has(v), [l, m]), u = Z4(v => {
                                    const x = null != n && 0 <= l.layout.cols.Ne(v, n.Xb) && 0 >= l.layout.cols.Ne(v, n.Kc);
                            ...
                            e = Y4(f => {
                                const {
                                    ...
                                    size: k,
                                    tqa: h
                                }), [k, h]), q = h ? Math.max(g, h) : g, r = Z4(v => null != m && a.rua(m).has(v), [m]), t = Z4(v => null != m && a.J6a(l, m).has(v), [l, m]), u = Z4(v => {
                                    const x = null != n && 0 <= l.layout.rows.Ne(v, n.bc) && 0 >= l.layout.rows.Ne(v, n.ad);
                                    return r(v) ? x ? "secondary-active" : "primary-active" : t(v) ? x ? "secondary-low" : "primary-low" : x ? "secondary-default" : "primary-default"
                                }, [l, n, t, r]);
                                return T4(a5, { ...f,
                                    Ed: q,
                    ...
                    JOb = function(a,
                        b) {
                        if (null != b && null != b.Xb && null != b.bc && null != b.Kc && null != b.ad) {
                            var c = a.za(b.Xb),
                                d = a.Aa(b.bc),
                    ...
                    POb = function(a, b, c, d, e, f) {
                        ...
                        a = g.map(n => {
                            ...
                            n = n.kc;
                            const y = m ? -1 : 1,
                                z = null === (p = h.get(f5(r, u))) || void 0 === p ? void 0 : p.Sa;
                            p = null === (q = h.get(f5(t, u))) || void 0 === q ? void 0 : q.za;
                            if (null != z && null != p) {
                                q = D(k.get(u.ua));
                        ...
                        return [...f.map(n => {
                            ...
                            const v = n.color,
                                x = n.weight;
                            n = n.kc;
                            const y = null === (p = h.get(f5(r, t))) || void 0 === p ? void 0 : p.La;
                            p = null === (q = h.get(f5(r, u))) || void 0 === q ? void 0 : q.Aa;
                            if (null != y && null != p) {
                                q = D(l.get(r.column));
                                var z = D(k.get(t.ua));
                                t = D(k.get(u.ua));
                    ...
                    SOb = function(a, b, c, d) {
                        ...
                        for (const k of b.get())
                            for (const l of c.get()) b = l && k ? e.uQa.Qeb(a, l, k) : void 0, b && h.set(`${l.id}:${k.id}`, b);
                        c = POb(e, a, h, f, g, d);
                        return QOb(c)
                    },
                    MOb = function(a, b, c, d) {
                        ...
                        for (const k of c)
                            for (const l of d) {
                                ...
                                if (!g || ("start" === k.boundary ? g.span.bc === c : g.span.ad === c))
                                    if (c = b.get(`${f.id}:${c.id}`), c = "start" === k.boundary ? null === c || void 0 === c ? void 0 : c.Aa : null === c || void 0 === c ? void 0 : c.La) {
                                        g = e[e.length - 1];
                                        ...
                                        var h;
                                        if (h = g) h = g.ama, h = h.column === l.column && h.boundary === l.boundary;
                                        h && (h = g.dPa, h = h.ua === k.ua && h.boundary === k.boundary);
                                        h && g.color === c.color && g.weight === c.weight && g.kc === c.kc && 0 === g.kc ? g.ama = f : e.push({
                                            dPa: k,
                                            Vgb: l,
                                            ama: f,
                                            color: c.color,
                    ...
                    NOb = function(a, b, c, d, e) {
                        ...
                        for (const l of d)
                            for (const m of c) {
                                ...
                                if (!d || ("start" === l.boundary ? d.span.Xb === h : d.span.Kc === h))
                                    if (d = b.get(`${h.id}:${g.id}`),
                                        (d = "start" === l.boundary ? null === d || void 0 === d ? void 0 : d.za : null === d || void 0 === d ? void 0 : d.Sa) && ("start" !== l.boundary || 1 !== e(g, h))) {
                                        h = f[f.length - 1];
                                        ...
                                        var k;
                                        if (k = h) k = h.iCa, k = k.column === l.column && k.boundary === l.boundary;
                                        k && (k = h.dma, k = k.ua === m.ua && k.boundary === m.boundary);
                                        k && h.color === d.color && h.weight === d.weight && h.kc === d.kc && 0 === h.kc ? h.dma = g : f.push({
                                            iCa: l,
                                            dhb: m,
                                            dma: g,
                                            color: d.color,
                    ...
                    OOb = function(a, b, c, d, e) {
                        ...
                        e = [];
                        (k = b.layout.rows.Jc(d[0].ua)) && e.push({
                            ua: k,
                            boundary: "start"
                        });
                        e.push(...d);
                        ...
                        for (const q of h) {
                            h = (d = "start" === q.boundary ? q.column : void 0) ? b.layout.cols.Jc(d) : b.layout.cols.last();
                            for (const r of e) {
                                ...
                                k = "end" === q.boundary ? null === l || void 0 === l ? void 0 : l.Sa : null === m || void 0 === m ? void 0 : m.za;
                                m = "end" === r.boundary ? null === n || void 0 ===
                                    n ? void 0 : n.La : null === m || void 0 === m ? void 0 : m.Aa;
                                n = "end" === q.boundary ? null === p || void 0 === p ? void 0 : p.Sa : null === n || void 0 === n ? void 0 : n.za;
                                l = "end" === r.boundary ? null === p || void 0 === p ? void 0 : p.La : null === l || void 0 === l ? void 0 : l.Aa;
                                p = __c.sGa({
                                    Aa: n,
                                    La: k,
                                    za: l,
                    ...
                    g5 = function(a, b, c, d, e) {
                        if (a && b) {
                            ...
                            return __c.RI(b.borderStyle, a.borderStyle, d, c, e, null === f || void 0 === f ? void 0 : f.borderStyle)
                        }
                    ...
                    TOb = function(a,
                        ...
                        var d = b && c && a.layout.cells.get(c, b),
                            e, f, g = b && c ? a.layout.attrs.get(Gg({
                                c6: void 0,
                                AQ: void 0,
                                g6: void 0
                            }), null !== (e = null === d || void 0 === d ? void 0 : d.span.bc) && void 0 !== e ? e : c, null !== (f = null === d || void 0 === d ? void 0 : d.span.Xb) && void 0 !== f ? f : b) || {} : void 0;
                        if (b && c) {
                            b = {
                                color: a.nj.color,
                                weight: a.nj.weight,
                            ...
                            d = i5(g.AQ);
                            g = j5(g.g6);
                            return null == c && null == d && null == g ? a.Cm ? void 0 : {
                                borderStyle: b,
                                Rt: !0
                            } : {
                                borderStyle: {
                    ...
                    WOb = function(a, b, c) {
                        var d = b && c && a.layout.cells.get(c, b),
                            e, f, g = b && c ? a.layout.attrs.get(Gg({
                                ...
                                BQ: void 0,
                                i6: void 0
                            }), null !== (e = null === d || void 0 === d ? void 0 : d.span.bc) && void 0 !== e ? e : c, null !== (f = null === d || void 0 === d ? void 0 : d.span.Xb) && void 0 !== f ? f : b) || {} :
                            void 0;
                        if (b && c) {
                            b = {
                                color: a.nj.color,
                    ...
                    XOb = function(a, b) {
                        return (null === a || void 0 === a ? void 0 : a.La) === (null === b || void 0 === b ? void 0 : b.La) && (null === a || void 0 === a ? void 0 : a.Aa) === (null === b || void 0 === b ? void 0 : b.Aa) && (null === a || void 0 === a ? void 0 : a.Sa) === (null === b || void 0 === b ? void 0 : b.Sa) && (null === a || void 0 === a ? void 0 : a.za) === (null === b || void 0 === b ? void 0 : b.za)
                    },
                    $Ob = function(a) {
                        const b = {
                            ...
                            d = l5(() => a.lG.style || c, g => {
                                ...
                                g = null === g || void 0 === g ? void 0 : null === (h = g.Ga) || void 0 === h ? void 0 : h.textDecoration;
                                a.tH.classList.toggle("OQx3PQ", "underline" === g);
                                a.tH.classList.toggle("_99ezUA", "line-through" === g);
                                a.tH.classList.toggle("kppAqQ", "underline line-through" === g)
                            }, {
                                fireImmediately: !0,
                                equals: YOb
                            }),
                            ...
                            f = l5(() => a.renderer, g => {
                                a.q7 && "react" !== (null === g || void 0 === g ? void 0 : g.type) ? (a.q7 = void 0, a.w1.remove()) : a.SD.innerHTML = "";
                        ...
                        return o5("div", {
                            ...
                            children: [o5("div", {
                                ...
                                children: [T4(a.Vp, { ...a,
                                    ...
                                    children: null === (c = a.Hya) || void 0 === c ? void 0 : null === (b = c.get()) || void 0 === b ? void 0 : b.map((g, h) => T4(g, {}, h))
                                })]
                            }), "visible" === a.Ktb && o5(cPb, {
                                children: [T4("div", {
                ...
                var tOb = a => __c.TFa((b, c) => {
                        ...
                        if (d.value.isEmpty)
                            ...
                            pi: b
                        } = __c.Yf(__c.Fg, b.attrs)), "wrap" === b && (c = c.appendChild(document.createElement("div")), c.className = "dt4Dlg"), a.render({
                            container: c,
                            text: d.value,
                            Ma: void 0,
                            writingMode: 1,
                ...
                var yOb = class {
                    ...
                    constructor() {
                        ...
                        this.rua = z5(a => {
                            var b;
                            return new Set((null === (b = a.get()) || void 0 === b ?
                                void 0 : b.rows) || [])
                        }, {
                            equals: __c.es
                        });
                        this.I6a = y5((a, b) => {
                            ...
                            for (const e of c) {
                                ...
                                for (const f of oOb(c ? c.span.Xb : e.column, c ? c.span.Kc : e.column, a.layout.cols))(0 === b.size || b.has(f)) && d.add(f)
                            }
                            return d
                        }, {
                            equals: __c.es
                        ...
                        this.J6a = y5((a, b) => {
                            ...
                            for (const e of c) {
                                c = a.layout.cells.get(e.ua, e.column);
                                for (const f of oOb(c ? c.span.bc : e.ua, c ? c.span.ad : e.ua, a.layout.rows))(0 === b.size || b.has(f)) && d.add(f)
                            }
                            return d
                        }, {
                            equals: __c.es
                ...
                var pPb = parseInt("4px", 10) || 4,
                    $4 = class extends q5 {
                        ...
                        get Aq() {
                            var a;
                            const b = null === (a = this.props.cp) || void 0 === a ? void 0 : a.get();
                            if (null != b && 0 !== b.length) return new __c.tF(b)
                        }
                        get d3() {
                            var a, b, c;
                            return null === (b = (c = this.props).kna) || void 0 === b ? void 0 : null === (a = b.call(c)) || void 0 === a ? void 0 : a.get()
                        }
                        render() {
                            return T4(__c.mA, {
                                mq: "light",
                        ...
                        constructor(...a) {
                            ...
                            this.GOa = (b, c, d) => {
                                const {
                                    ...
                                    jNbTIg: !this.Cd,
                                    gtA7Dw: this.Cd
                                }, m = (null === d || void 0 === d ? 0 : d.sticky) ? this.Cd ? {
                                    right: 0
                                } : {
                                    left: 0
                                } : void 0;
                                var n;
                                const p = (null === d || void 0 === d ? 0 : d.sticky) ? null !== (n = this.d3) && void 0 !== n ? n : m : void 0;
                                let q = -1;
                                return o5("div", {
                                    style: p,
                                    ...
                                    children: [e.layout.cols.map(r => {
                                        q++;
                                        if (!(b && 0 > e.layout.cols.Ne(r, b) || c && 0 < e.layout.cols.Ne(r, c))) return T4(qPb, {
                                            col: r,
                                            label: __c.rC(q),
                                            ep: f,
                                            EE: g,
                                    ...
                                    }), (null === d || void 0 === d ? void 0 : d.sticky) && T4("div", {
                                        style: {
                                            width: pPb * h
                                        },
                            ...
                            this.H_a = b => {
                                ...
                                const d = this.props.sheet,
                                    e = d.view.freeze.vH ?
                                    d.layout.Hd.get(d.view.freeze.vH) : void 0,
                                    f = {
                                        jNbTIg: !this.Cd,
                                        gtA7Dw: this.Cd
                                    };
                ...
                var a5 = class extends q5 {
                    ...
                    constructor(...a) {
                        ...
                        this.KOa = (b, c, d) => {
                            ...
                            return o5("div", {
                                ...
                                children: [e.rows.map(r => {
                                    q++;
                                    if (!(b && 0 > e.rows.Ne(r, b) || c && 0 < e.rows.Ne(r, c))) return T4(rPb, {
                                        ua: r,
                                        label: `${q+1}`,
                                        EE: g,
                                        ep: f,
                        ...
                        this.ffb = b => {
                            var c;
                            const d = this.props.sheet,
                                e = d.view.freeze.BU ? d.layout.Sd.get(d.view.freeze.BU) : void 0,
                                f = {
                                    jNbTIg: !this.Cd,
                                    gtA7Dw: this.Cd
                                };
                ...
                var sPb = '<svg width="12" height="12" viewBox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg"><circle stroke="currentColor" cx="6" cy="6" r="5.5"/></svg>';
                var tPb = '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><circle stroke="currentColor" cx="12" cy="12" r="9.25" stroke-width="1.5"/></svg>';
                var wOb = __c.jS({
                    uo: sPb,
                    medium: tPb
                });
                ...
                var HOb = Y4(a => {
                    ...
                    vPb = class extends __c.BS {
                        ...
                        get iP() {
                            const a =
                                (this.N_.width - this.Gda.width) / 2;
                            return {
                                left: -a,
                                right: this.Gda.width + a
                            }
                        }
                        constructor(a, b, c) {
                            super();
                ...
                var A5 = parseInt("4px", 10) || 4,
                    wPb = Y4(({
                        ...
                        if (null != c && (d || e)) {
                            ...
                            if (d && e) return d = a.Aa(c.ad) + c.ad.height, a = a.za(c.Kc) + c.Kc.width, T4("div", {
                                style: {
                                    top: d * b,
                                    width: a * b,
                                    height: A5 * b
                            ...
                            if (d) return c = a.za(c.Kc) + c.Kc.width, T4("div", {
                                style: {
                                    left: c * b,
                                    width: A5 * b,
                                    height: a.height * b
                            ...
                            if (e) return c = a.Aa(c.ad) + c.ad.height, T4("div", {
                                style: {
                                    top: c * b,
                                    width: a.width *
                                        b,
                ...
                var B5 = ({
                        ...
                        return T4("div", {
                            ref: e,
                            className: V4("nstn2A", "rtl" === a.direction ? "NgnL2Q" : "f8jAGQ"),
                            children: d
                        })
                    },
                    xPb = ({
                ...
                var GOb = Y4(a => {
                    ...
                    c5(() => d5(() => {
                        var u = b.config.view.freeze.vH ? b.config.layout.Hd.get(b.config.view.freeze.vH) : void 0;
                        if (null != u) {
                            var v = Math.min(h.width, b.F);
                            if (b.config.za(u) + u.width > v) {
                                if (u = r.yC.get(b)) u.style.overflowX = "hidden"
                            } else if (u =
                                r.yC.get(b)) u.style.overflowX = "scroll"
                        }
                    }), [b, h.width, r]);
                    return T4("div", {
                        ref: e,
                ...
                var yPb = Y4(({
                    ...
                    return T4("div", {
                        className: "Gi9pfA",
                        children: a.elements.map((e, f) => null == d ? c(e, f) : __c.zv(__c.Bv(e)).Pq(d) && c(e, f))
                    })
                });
                var zPb = new __c.OS,
                    C5 = a => __c.R_ * a,
                    ...
                    BPb = Y4(a => {
                        ...
                        c5(() => {
                            ...
                            return l5(() => null === y || void 0 === y ? void 0 : y.get(), z => {
                                const A = n.current;
                                if (z && A) {
                                    var C =
                                        "rtl" === l.sheet.direction,
                                        F;
                                    A.style.position = null !== (F = z.position) && void 0 !== F ? F : "sticky";
                                    var H;
                                    A.style.top = null !== (H = z.top) && void 0 !== H ? H : "0px";
                                    var I, J;
                                    C ? A.style.right = null !== (I = z.right) && void 0 !== I ? I : "0px" : A.style.left = null !== (J = z.left) && void 0 !== J ? J : "0px";
                                    var L;
                                    A.style.transform = null !== (L = z.transform) && void 0 !== L ? L : ""
                                }
                            })
                        }, [l.sheet, c, d]);
                        c5(() => {
                            ...
                            return l5(() => null === y || void 0 === y ? void 0 : y.get(), z => {
                                ...
                                if (z && A) {
                                    ...
                                    var F;
                                    A.style.top = null !== (F = z.top) && void 0 !== F ? F : "0px";
                                    var H;
                                    A.style.transform = null !== (H = z.transform) && void 0 !== H ? H : ""
                                }
                            })
                        }, [l.sheet, c, d]);
                        c5(() => {
                            ...
                            return l5(() => null === y || void 0 === y ? void 0 : y.get(), z => {
                                ...
                                if (z && A) {
                                    ...
                                    A.style.position = null !== (F = z.position) && void 0 !== F ? F : "sticky";
                                    var H, I;
                                    C ? A.style.right = null !== (H = z.right) && void 0 !== H ? H : "0px" : A.style.left =
                                        null !== (I = z.left) && void 0 !== I ? I : "0px";
                                    var J;
                                    A.style.transform = null !== (J = z.transform) && void 0 !== J ? J : ""
                                }
                            })
                        }, [l.sheet, c, d]);
                        const r = Z4((y, z, A) => D5({
                            ...
                            u = X4(() => r ? () => r(l.sheet, !1, !0) : void 0, [r, l.sheet]);
                        var v;
                        const x = null !== (v = null === c || void 0 === c ? void 0 : c.get()) && void 0 !== v ? v : 1;
                        return o5("div", {
                            className: "OsKKIQ",
                            children: [T4("div", {
                                ref: n,
                    ...
                    D5 = ({
                        ...
                        var f = null === e || void 0 === e ? void 0 : __c.Jv(e.get()),
                            g;
                        const h = null !== (g = null === d || void 0 === d ? void 0 : d.get()) && void 0 !==
                            g ? g : 1;
                        if (!f) return {};
                        g = {};
                ...
                var f5 = (a, b) => `${a.column.id}-${a.boundary}:${b.ua.id}-${b.boundary}`,
                    DPb = class {
                        constructor() {
                            this.uQa = CPb;
                            this.U5a = z5(a => {
                            ...
                            this.p5a = z5(a => {
                                ...
                                const d = c ? -1 : 1;
                                let e = 0;
                                c && (c = a.layout.cols.last(), e = null != c ? a.za(c) + c.width : 0);
                        ...
                        constructor() {
                            this.Qeb =
                                y5((a, b, c) => {
                                    ...
                                    var e, f, g = k5(null !== (e = null === d || void 0 === d ? void 0 : d.span.Xb) && void 0 !== e ? e : b, null !== (f = null === d || void 0 === d ? void 0 : d.span.Kc) && void 0 !== f ? f : b, a.layout.cols),
                                        h, k;
                                    e = k5(null !== (h = null === d || void 0 === d ? void 0 : d.span.bc) && void 0 !== h ? h : c, null !== (k = null === d || void 0 === d ? void 0 : d.span.ad) && void 0 !== k ? k : c, a.layout.rows);
                                    ...
                                    if (n || f || l || m) {
                                        ...
                                        if (l) {
                                            ...
                                            p = b && p && UOb(a, b, p);
                                            var t, u;
                                            const ja = k5(null !== (t = null === Z || void 0 === Z ? void 0 : Z.span.Xb) && void 0 !== t ? t : b, null !== (u = null === Z || void 0 === Z ? void 0 : Z.span.Kc) && void 0 !== u ? u : b, a.layout.cols);
                                            var v, x;
                                            t = a.layout.cols.Ne(null !== (v = null === d || void 0 === d ? void 0 : d.span.Xb) && void 0 !== v ? v : b, null !== (x = null === Z || void 0 === Z ? void 0 : Z.span.Xb) && void 0 !== x ? x : b);
                                            h.Aa = g5(l, p, g, ja, t)
                                        }
                                        if (m) {
                                            v = UOb(a, b, c);
                                            ...
                                            t = b && q && TOb(a, b, q);
                                            var y, z;
                                            u = k5(null !== (y = null === x || void 0 === x ? void 0 : x.span.Xb) && void 0 !== y ? y : b, null !== (z = null === x || void 0 === x ? void 0 : x.span.Kc) && void 0 !== z ? z : b, a.layout.cols);
                                            var A, C;
                                            y = a.layout.cols.Ne(null !== (A = null === d || void 0 === d ? void 0 : d.span.Xb) && void 0 !== A ? A : b, null !== (C = null === x || void 0 === x ? void 0 : x.span.Xb) && void 0 !== C ? C : b);
                                            h.La = g5(v, t, g, u, y)
                                        }
                                        if (n) {
                                            g = VOb(a, b, c);
                                            ...
                                            C = r && c && WOb(a, r, c);
                                            var F, H;
                                            y = k5(null !== (F = null === A || void 0 === A ? void 0 : A.span.bc) && void 0 !== F ?
                                                F : c, null !== (H = null === A || void 0 === A ? void 0 : A.span.ad) && void 0 !== H ? H : c, a.layout.rows);
                                            var I, J;
                                            F = a.layout.rows.Ne(null !== (I = null === d || void 0 === d ? void 0 : d.span.bc) && void 0 !== I ? I : c, null !== (J = null === A || void 0 === A ? void 0 : A.span.bc) && void 0 !== J ? J : c);
                                            h.za = g5(g, C, e, y, F)
                                        }
                                        if (f) {
                                            b = WOb(a, b, c);
                                            ...
                                            J = k && c && VOb(a, k, c);
                                            var L, Q;
                                            F = k5(null !== (L = null === I || void 0 === I ? void 0 : I.span.bc) && void 0 !== L ? L : c, null !== (Q = null === I || void 0 === I ? void 0 : I.span.ad) && void 0 !== Q ? Q : c, a.layout.rows);
                                            var P, V;
                                            a = a.layout.rows.Ne(null !==
                                                (P = null === d || void 0 === d ? void 0 : d.span.bc) && void 0 !== P ? P : c, null !== (V = null === I || void 0 === I ? void 0 : I.span.bc) && void 0 !== V ? V : c);
                                            h.Sa = g5(b, J, e, F, a)
                                        }
                                        return h
                                    }
                    ...
                    constructor(a) {
                                    ...
                                    if (k = e(c, g)) {
                                        ...
                                        if (!(g.width >
                                            ...
                                            for (l = d.indexOf(g); 0 <= l; l--) {
                                                ...
                                                var n;
                                                if (n = m === g || NI(b, c, m)) n = b.za(m), n = h < n && n < k;
                                                if (n && q) f.set(m, 1);
                                                else break
                                            }
                                            for (g = d.indexOf(g) + 1; g < d.length; g++) {
                                                l = d[g];
                                                if (m = NI(b, c, l)) m = b.za(l), m = h < m && m < k;
                                                if (m) f.set(l, 1);
                                                else break
                                            }
                                        }
                        ...
                        this.y5a = (b, c, d) => {
                            ...
                            const g = b.layout.cells.get(c,
                                d);
                            if (g && (g.ref.content.ref || g.ref.Ha.ref) && g.span.bc === g.span.ad && g.span.Xb === g.span.Kc) {
                                var {
                                    pi: h,
                                    textAlign: k
                                } = __c.Yf(__c.Fg, b.layout.attrs.get(Gg({
                                    pi: void 0,
                                    textAlign: void 0
                                }), c, d) || {});
                                if ("overflow" === h) {
                                    var l = this.B2.FE(b, c, d);
                                    return __c.MI(k, null === (e = g.ref.content.ref) || void 0 === e ? void 0 : e.type, null === (f = g.ref.Ha.ref) || void 0 === f ? void 0 : f.type, l ? () => l.Uo.type : void 0)
                                }
                            }
                        }
                    }
                ...
                var FPb = Y4(function(a) {
                    ...
                    var l = Z4((p, q) => {
                        var r, t;
                        return null !== (t = null === (r = k(p)) || void 0 === r ? void 0 : r.get(q)) && void 0 !== t ? t : 0
                    }, [k]);
                    c = SOb(b, c, d, l);
                    c = dPb(c);
                    l = b.width;
                ...
                var F5 = class extends q5 {
                    ...
                    render() {
                        ...
                        return o5("div", {
                            ref: this.xQa,
                            className: V4("ZTz_iA", "ltr" === d.direction ? "TA4X7w" : "WvuqMw"),
                            children: [(null === b || void 0 === b ? void 0 : b.ZAa) && T4(E5, { ...c,
                                sheet: d,
                                range: b.ZAa.range,
                                Lv: !0,
                                Mv: !0,
                                className: "_0C8M3w",
                                M6: this.D8
                            }), (null === b || void 0 === b ? void 0 : b.lUa) && T4(E5, { ...c,
                                sheet: d,
                                range: b.lUa.range,
                                Lv: !1,
                                Mv: !0,
                                className: "_7n44yg",
                                M6: this.D8
                            }), (null === b || void 0 === b ? void 0 : b.rHa) && T4(E5, { ...c,
                                sheet: d,
                                range: b.rHa.range,
                                Lv: !0,
                                Mv: !1,
                                className: "fF5r6w",
                                M6: this.D8
                            }), (null === b || void 0 === b ? void 0 : b.Mwa) && T4(E5, { ...c,
                                sheet: d,
                                range: null === b || void 0 === b ? void 0 : null === (a = b.Mwa) || void 0 === a ? void 0 : a.range,
                                Lv: !1,
                                Mv: !1,
                                className: "llILYw",
                                M6: this.wTa
                    ...
                    constructor(...a) {
                        ...
                        this.d_a = (b, c) => {
                            ...
                            var f = this.props.iZ;
                            f = null === f || void 0 === f ? void 0 : null === (d = f.Mwa) || void 0 === d ? void 0 : d.range;
                            return e.layout.cols.has(b) && e.layout.rows.has(c) ? null == f ? !0 : 0 >= e.layout.cols.Ne(f.Xb, b) && 0 >= e.layout.cols.Ne(b, f.Kc) && 0 >= e.layout.rows.Ne(f.bc, c) && 0 >= e.layout.rows.Ne(c, f.ad) : !1
                        }
                    }
                };
                F5 = w5([Jc], F5);
                var E5 = class extends q5 {
                            ...
                            children: [T4("div", {
                                ...
                                children: T4("div", {
                                    ...
                                    children: T4(G5, {
                                        ...
                                        q_: "hidden" === (null === d || void 0 === d ? void 0 : d.type) ? d.isVisible : void 0,
                                        cp: this.props.cp,
                                        eD: this.props.eD,
                                        ph: this.props.ph,
                                        TX: this.props.TX,
                        ...
                        c = d5(() => {
                            ...
                            if (null != g) {
                                ...
                                if (null == f) g.style.position = h, g.style.top = k, g.style.left = n ? "unset" : l, g.style.right = n ? m : "unset";
                                    ...
                                    var t;
                                    g.style.right = n ? null !== (t = v.right) &&
                                        void 0 !== t ? t : m : "unset";
                                    var u;
                    ...
                    get bounds() {
                        ...
                        var c, d, e, f;
                        return {
                            Xb: null !== (c = null === b || void 0 === b ? void 0 : b.Xb) && void 0 !== c ? c : a.layout.cols.first(),
                            Kc: null !== (d = null === b || void 0 === b ? void 0 : b.Kc) && void 0 !== d ? d : a.layout.cols.last(),
                            bc: null !== (e = null === b || void 0 === b ? void 0 : b.bc) && void 0 !== e ? e : a.layout.rows.first(),
                            ad: null !== (f = null === b || void 0 === b ? void 0 : b.ad) && void 0 !== f ? f : a.layout.rows.last()
                        }
                    }
                    constructor(...a) {
                        super(...a);
                        ...
                        this.XMa = kz();
                        this.gR = new HPb;
                        this.Kjb = e5(() => [...this.Sp.get().keys()].sort((b, c) => this.props.sheet.layout.rows.Ne(b, c)), {
                            equals: __c.hs()
                        });
                        this.Hjb = e5(() => [...this.Mfa.get().keys()].sort((b, c) => this.props.sheet.layout.cols.Ne(b, c)), {
                            equals: __c.hs()
                        });
                        this.Oga = Y4(() => T4(this.props.XWa, {
                            Sp: this.Kjb,
                            Ijb: this.Hjb,
                            n5a: this.gR.u5a,
                        ...
                        this.Sp = e5(() => {
                            ...
                            var d = this.props.Y,
                                e = null === (b = this.Yua) || void 0 === b ? void 0 :
                                b.get();
                            ...
                            f = new Map;
                            for (let h = b.bc; null != h && null != b.ad && 0 >= c.layout.rows.Ne(h, b.ad); h = c.layout.rows.next(h)) {
                                const k = c.Aa(h);
                                if (!(k + h.height < g)) {
                                    if (k > e) break;
                                    f.set(h, k * d)
                        ...
                        this.Mfa = e5(() => {
                            ...
                            const c = this.props.sheet;
                            var d = this.props.Y,
                                e = null === (b = this.Yua) || void 0 === b ? void 0 : b.get();
                            if (e && (0 >= e.height || 0 >=
                                    e.width)) return new Map;
                            b = this.bounds;
                            d = d.get();
                            var f = 50 * d;
                            ...
                            f = new Map;
                            for (let h = b.Xb; null != h && null != b.Kc && 0 >= c.layout.cols.Ne(h, b.Kc); h = c.layout.cols.next(h)) {
                                const k = c.za(h);
                                if (!(k + h.width < g)) {
                                    if (k > e) break;
                                    f.set(h, k * d)
                ...
                var HPb = class {
                    ...
                    G5 = class extends q5 {
                        ...
                        render() {
                            var a;
                            return o5("div", {
                                ref: kPb(this.Od, null === (a = this.Aq) || void 0 === a ? void 0 : a.Vl),
                                children: [T4("div", {
                                    ref: this.uja,
                                    className: "_5YlOqQ"
                                }), T4("div", {
                        ...
                        componentDidMount() {
                            const a = l5(() => [this.props.sheet, this.props.Mfa.get(), this.props.Sp.get()], ([d, e, f], g) => {
                                    [g] = g || [];
                                    d !== g && (d = D(this.uja.current), g = D(this.wja.current), d.innerHTML =
                                        "", g.innerHTML = "", this.qxa.length = 0, this.vK.length = 0);
                                    this.IAa(e, f)
                                }, {
                                    fireImmediately: !0
                                }),
                        ...
                        IAa(a, b) {
                            const c = D(this.uja.current),
                                ...
                                e = [],
                                f = new Map;
                            for (const g of this.qxa) b.has(g.ua) ? f.set(g.ua, g) : e.push(g);
                            for (const [g, h] of b) b = f.get(g) || e.pop(), b || (b = new IPb(this.u7, g), c.appendChild(b.J6),
                                d.appendChild(b.L6), this.qxa.push(b)), b.update(h, g, a);
                        ...
                        u7(a, b) {
                            const c = this.props.TX,
                                ...
                                f = this.props.q_,
                                g = this.props.gR;
                            a = new JPb(this.props.eD, this.props.ph, c(a, b), d, a, b, e, f, g.wta);
                            __c.wc(this, $Ob(a));
                            this.vK.push(a);
                            return a
                        }
                ...
                var IPb = class {
                        ...
                        update(a, b, c) {
                            ...
                            this.ua = b;
                            for (const [d] of c) c = this.vK.get(d), c || (c = this.u7(d, b), this.vK.set(d, c), this.J6.appendChild(c.I6), this.L6.appendChild(c.MQ)), c.update(b)
                        }
                        hide() {
                    ...
                    JPb = class {
                        ...
                        update(a) {
                            a !== this.ua && (this.ua = a, this.lG.ua = a, this.sla && this.sla(), this.sla = this.wta(this.ua, this.col, this))
                        }
                        get wdb() {
                            return this.q7
                        }
                        get yv() {
                            ...
                            if (!a || a.span.bc === this.ua && a.span.Xb === this.col) return a ? a.ref : void 0
                        }
                        get attrs() {
                            return this.sheet.layout.attrs.get(Gg({
                                    pi: 0,
                                    textAlign: 0,
                                    direction: 0
                                }), this.ua,
                        ...
                        get renderer() {
                            if (this.q_) {
                                var a = this.yv;
                                if (a && (a.content.ref || a.Ha.ref)) return this.eD({
                                    context: {
                                        container: this.wv,
                                        attrs: this.attrs
                                    },
                        ...
                        get LCa() {
                            ...
                            if (a && (a = "react" === a.type ? this.w1 : this.SD, 0 !== a.childNodes.length && (a = a.childNodes[0], a instanceof HTMLElement))) return {
                                width: a.clientWidth,
                        ...
                        constructor(a, b, c, d, e, f, g, h, k) {
                            ...
                            this.tH.className = V4("pDMp7w", {
                                _0yZ6Qg: "text3" !== (null === (m = this.yv) || void 0 === m ? void 0 : null === (l = m.content.ref) || void 0 === l ? void 0 : l.type),
                                qhF5uA: "text3" !== (null === (p = this.yv) || void 0 === p ? void 0 : null === (n = p.content.ref) || void 0 === n ? void 0 : n.type) && "text2" !== (null === (r = this.yv) || void 0 === r ? void 0 : null === (q = r.content.ref) || void 0 === q ? void 0 : q.type)
                            });
                ...
                var m5 = class extends q5 {
                    ...
                    render() {
                        ...
                        return T4("div", {
                            className: V4("SNkrHw", "ltr" === a.direction ? "TA4X7w" : "WvuqMw", {
                                RaA0Nw: l
                            }),
                            ...f,
                            children: T4(F5, {
                    ...
                    get iZ() {
                        ...
                        const b = {},
                            ...
                            d = a.view.freeze.vH ? a.layout.Hd.get(a.view.freeze.vH) :
                            void 0,
                    ...
                    constructor(...a) {
                        ...
                        this.TX = (b, c) => new __c.kGa(this.props.Pz, this.props.sheet, b, c, this.Y, this.Lt, this.Nt);
                        this.Lt = (b, c) => {
                            var d, e;
                            return null === (d = (e = this.props).Lt) || void 0 === d ? void 0 : d.call(e, this.props.sheet, b, c)
                        };
                        this.Nt = (b, c) => {
                            var d, e;
                            return null === (d = (e = this.props).Nt) || void 0 === d ? void 0 : d.call(e, this.props.sheet, b, c)
                        }
                    }
                };
                m5 = w5([Jc], m5);
