        ...
        537666: function(_, __, __webpack_require__) {
            ...
            (function(__c) {
                ...
                var cMb = function(a, b, c) {
                    ...
                    e4 = function(a) {
                        const b = (c, d) => {
                            ...
                            if ("string" !== (null === c || void 0 === c ? void 0 : c.type)) throw "toWidgetData" === d ? new c4("string", c) : new d4("string", c);
                            return c.value
                        };
                        return {
                            zk: c => ({
                    ...
                    g4 = function(a, b) {
                        if (0 === a.length) throw new f4("At least one value must be provided for literal types.");
                        const c = new Set(a),
                            d = (e, f) => {
                                if (null == e) return b;
                                if ("string" !== (null === e || void 0 === e ? void 0 : e.type) || !c.has(e.value)) throw "toWidgetData" === f ? new c4("literal", e) : new d4("literal", e);
                                return e.value
                            };
                        return {
                            zk: e => ({
                    ...
                    h4 = function(a) {
                        const b = (c, d) => {
                            ...
                            if ("double" !== (null === c || void 0 === c ? void 0 : c.type) || !Number.isFinite(c.value)) throw "toWidgetData" === d ? new c4("double",
                                c) : new d4("double", c);
                            return c.value
                        };
                        return {
                    ...
                    hMb = function() {
                        const a = b => {
                            if ("fill" !== (null === b || void 0 === b ? void 0 : b.type)) throw new c4("fill", b);
                            return b.value
                        };
                        return {
                            zk: b => ({
                            ...
                            Os: b => {
                                if ("fill" !== (null === b || void 0 === b ? void 0 : b.type)) throw new d4("fill", b);
                                return b.value
                            },
                            Ns: a,
                            Lu: a
                    ...
                    j4 = function(a) {
                        ...
                        for (const d of Object.keys(a)) {
                            const [e] =
                            a[d];
                            if (b.has(e)) throw new f4(`Duplicate serialized keys "${e}" found in record schema.`);
                            b.add(e)
                        }
                        const c = (d, e) => {
                            if ("dict" !== (null === e || void 0 === e ? void 0 : e.type)) throw new c4("record", e);
                            const f = {};
                            for (const g of Object.keys(a)) {
                                ...
                                Object.defineProperty(f, g, {
                                    ...
                                    set(m) {
                                        "readonly" !== d && (m = k.zk(m), null == m ? e.value.delete(h) : e.value.set(h, m))
                                    },
                                    enumerable: !0
                                })
                            }
                        ...
                        return {
                            ...
                            Os: d => {
                                if ("dict" !== (null === d || void 0 === d ? void 0 : d.type)) throw new d4("record", d);
                                const e = {};
                                for (const f of Object.keys(a)) {
                                    const [g, h] = a[f], k = h.Os(d.value.get(g));
                                    null != k && (e[f] = k)
                                }
                                return e
                            },
                    ...
                    l4 = function(a) {
                        return {
                            ...
                            Os: b => {
                                if ("list" !== (null === b || void 0 === b ? void 0 : b.type)) throw new d4("list", b);
                                return b.value.filter(zb).map(c =>
                                    a.Os(c))
                            },
                            Ns: b => {
                                if ("list" !== (null === b || void 0 === b ? void 0 : b.type)) throw new c4("list", b);
                                return new iMb(b, a)
                            },
                            Lu: b => {
                                if ("list" !== (null === b || void 0 === b ? void 0 : b.type)) throw new c4("list", b);
                    ...
                    m4 = function(a, b) {
                        const c = new Set(Object.keys(a)),
                            d = e => {
                                var f;
                                if ("dict" !== (null === e || void 0 === e ? void 0 : e.type)) throw new c4("union",
                                    e);
                                const g = null === (f = e.value.get("k")) || void 0 === f ? void 0 : f.value;
                                f = e.value.get("v");
                                if (null == g || null == f || "string" !== typeof g || !c.has(g)) throw new c4("union", e);
                                return {
                                    G6: a[g],
                                    H6: f
                                }
                        ...
                        return {
                            ...
                            Os: e => {
                                var f;
                                if ("dict" !== (null === e || void 0 === e ? void 0 : e.type)) throw new d4("union", e);
                                const g = null === (f = e.value.get("k")) || void 0 === f ? void 0 : f.value;
                                f = e.value.get("v");
                                if (null == g || null == f || "string" !== typeof g ||
                                    !c.has(g)) throw new d4("union", e);
                                const {
                                    G6: h,
                                    H6: k
                                } = {
                    ...
                    kMb = function(a) {
                        ...
                        return {
                            sS: function() {
                                return a.Hm.sj ? 3 : "checking" === a.Hm.w7a ? 1 : a.Hm.I_ ? 2 : 0
                            },
                            jna: function() {
                                const c = a.Xe,
                                    {
                    ...
                    oMb = function(a, b, c, d, e, f) {
                        ...
                        async function h() {
                            ...
                            if (null != z && g())
                                if (x = null === (u = a.Xe.fields.first(({
                                        value: I
                                    }) => {
                                        var J;
                                        return !(null === (J = I.options.first(({
                                            value: L
                                        }) => L.id === z)) || void 0 === J || !J.value)
                                    ...
                                    null === d || void 0 === d ? void 0 : __c.ij(d, {
                                        Yt: O("izckBA"),
                                        group: nMb,
                                        bQ: {
                                            Bx: O("mQhziQ"),
                        ...
                        async function k(u) {
                            var v;
                            const x = r(),
                                y = null === (v = a.Xe.fields.first(({
                                    value: C
                                }) => {
                                    var F;
                                    return !(null === (F = C.options.first(({
                                        value: H
                                    }) => H.id === u)) || void 0 === F || !F.value)
                        ...
                        return {
                            ...
                            Vea: function(u) {
                                const v = r(),
                                    x = "poll" === p && u === (null === v || void 0 === v ? void 0 : v.lf) && u === (null === v || void 0 === v ? void 0 : v.bK);
                                if (g() && x) k(u);
                                else if (g() && a.Xe.fields.some(({
                                        value: z
                                    }) => z.options.some(({
                                        value: A
                                    }) => A.id === u))) {
                                    var y = null === v ||
                                        void 0 === v ? void 0 : v.bK;
                                    p4(() => {
                                        const z = r();
                                        a.Ul(() => ({
                                            Wz: t({
                    ...
                    o4 = function({
                        ...
                        var f;
                        d = Math.max(0, (null !== (f = e.lJ.get(c)) && void 0 !== f ? f : 0) - 1);
                        f = new Map(e.lJ);
                    ...
                    mMb = function({
                        ...
                        var d;
                        const e = null !== (d = a.fields.get(b)) && void 0 !==
                            d ? d : {
                                id: b,
                                lJ: new Map,
                                total: 0
                    ...
                    r4 = function(a, b) {
                        var c;
                        return ((null === (c = a.Ewa) || void 0 === c ? void 0 : c.get(a.document.language || "en")) || [])[qMb[b]]
                    },
                    rMb = async function() {
                        var {
                            Fwa: a
                    ...
                    v4 = function(a, b) {
                        ...
                        return 20 <= Math.sqrt(((f - c) / (1 + .015 * (k - 50) ** 2 / Math.sqrt(20 +
                            (k - 50) ** 2))) ** 2 + (n / (1 * q)) ** 2 + (p / (1 * r)) ** 2 + n / (1 * q) * (p / (1 * r)) * -(2 * Math.sqrt(l ** 7 / (l ** 7 + 25 ** 7))) * Math.sin(60 * Math.exp(-1 * ((m - 275) / 25) ** 2) * Math.PI / 180)) ? a : t4(b, u4)
                    },
                    w4 = function(a) {
                        switch (a.type) {
                            case "color":
                    ...
                    yMb = function({
                        ...
                        3 === g || 4 === g || 5 === g ? (b = (n = r4(b, "resultsPercentage")) ? cMb(n, [e], b.document.language) : __c.Hb("sUWUOA", [e]), k = {
                            id: "percentage",
                            placement: {
                                gridColumnStart: "4",
                                gridColumnEnd: "5",
                                ...
                                cells: e.map(({
                                    ...
                                    return {
                                        ...
                                        content: {
                                            ...
                                            Uk: () => {
                                                var y;
                                                return null === b || void 0 === b ? void 0 : null === (y = b.Vea) ||
                                                    void 0 === y ? void 0 : y.call(b, t.id)
                                            },
                                            onMouseEnter: () => {
                                                var y;
                                                return null === b || void 0 === b ? void 0 : null === (y = b.Naa) || void 0 === y ? void 0 : y.call(b, t.id)
                                            },
                                            onMouseLeave: () => {
                                                var y;
                                                return null === b || void 0 === b ? void 0 : null === (y = b.Oaa) || void 0 === y ? void 0 : y.call(b, t.id)
                                            },
                                            onMouseDown: () => {
                                                var y;
                                                return null === b || void 0 === b ? void 0 : null === (y = b.Laa) || void 0 === y ? void 0 : y.call(b, t.id)
                                            },
                                            onMouseUp: () => {
                                                var y;
                                                return null === b || void 0 === b ? void 0 : null === (y = b.Paa) || void 0 === y ? void 0 : y.call(b, t.id)
                                            },
                                            ...yMb({
                                                messages: q,
                                                $ra: t.label,
                        ...
                        switch (b) {
                            case 0:
                                ...
                                return {
                                    type: "text",
                                    pG: 1,
                                    text: A4(null !== (f = a.statusMessage) && void 0 !== f ? f : r4(a.messages, "live") || O("/iw6+Q"), c, d, t4(e, AMb), t4(e, u4))
                                };
                            case 1:
                                return {
                                    type: "text",
                            ...
                            case 2:
                                return {
                                    type: "text",
                                    pG: 1,
                                    text: A4(r4(a.messages, "submitting") || O("wutQEA"), c, d, t4(e, BMb), t4(e, u4))
                                };
                            case 3:
                                return {
                                    type: "text",
                                ...
                                cells: c.map(({
                                    ...
                                    return {
                                        ...
                                        content: {
                                            ...
                                            Uk: () => {
                                                var v;
                                                return null === a || void 0 === a ? void 0 : null === (v = a.Vea) || void 0 === v ? void 0 : v.call(a, p.id)
                                            },
                                            onMouseEnter: () => {
                                                var v;
                                                return null === a || void 0 === a ? void 0 : null === (v = a.Naa) || void 0 === v ? void 0 : v.call(a, p.id)
                                            },
                                            onMouseLeave: () => {
                                                var v;
                                                return null === a || void 0 === a ? void 0 : null === (v = a.Oaa) || void 0 === v ? void 0 : v.call(a, p.id)
                                            },
                                            onMouseDown: () => {
                                                var v;
                                                return null === a || void 0 === a ? void 0 : null === (v = a.Laa) || void 0 === v ? void 0 : v.call(a, p.id)
                                            },
                                            onMouseUp: () => {
                                                var v;
                                                return null === a || void 0 === a ? void 0 : null === (v = a.Paa) || void 0 === v ? void 0 : v.call(a, p.id)
                                            },
                                            ...IMb({
                                                direction: b,
                                                $ra: p.label,
                        ...
                        return {
                            ...
                            content: tMb({
                                ...
                                background: {
                                    type: "color",
                                    color: 2 === d ? m : 1 === d ? l : c,
                                    Pa: (null === e || void 0 === e ? 0 : e.submit) ? f ? .1 : void 0 : .6
                                },
                                V: 24,
                                padding: 12,
                                content: x4(b, {
                            ...
                            content: s4({
                                ...
                                cells: [{
                                    ...
                                    content: {
                                        ...
                                        pG: 0,
                                        fontFamily: d,
                                        text: h ? r4(c, "correctLabel") || O("i3mNPA") : r4(c, "incorrectLabel") || O("As1GTA"),
                                        fontSize: LMb,
                                        fontWeight: "bold",
                                        textAlign: "center",
                                        direction: z4(b),
                ...
                var k4 = class {
                        ...
                        get PDa() {
                            ...
                            for (const b of this.list.value) {
                                const c = a4(this, b);
                                if (void 0 === c) throw new fMb("undefined value found when deserializing list.");
                                a.push(c)
                            }
                            return a
                        }
                        ...
                        first(a) {
                            const b = this.list.value.first(a ? c => a(a4(this, c)) : void 0);
                            if (null != b) return a4(this, b)
                        }
                        last(a) {
                            const b = this.list.value.last(a ? c => a(a4(this, c)) : void 0);
                            if (null != b) return a4(this, b)
                        }
                        next(a, b) {
                            var c =
                                b ? d => b(a4(this, d)) : void 0;
                            a = b4(this, a);
                        ...
                        filter(a) {
                            return this.list.value.filter((b, c) => a(a4(this, b), c)).map(b => a4(this, b))
                        }
                        forEach(a) {
                    ...
                    iMb = class extends k4 {
                        ...
                        GM(a, b) {
                            a = null != a ? b4(this, a) : void 0;
                            return this.list.value.GM(a, b.map(c => this.Iz.zk(c))).map(c => a4(this, c))
                        }
                        insertBefore(a, b) {
                            a = null != a ? b4(this, a) : void 0;
                        ...
                        append(a) {
                            a =
                                this.list.value.append(this.Iz.zk(a));
                            return a4(this, a)
                        }
                        prepend(a) {
                ...
                var QMb = j4({
                        ...
                        text: ["te", function() {
                            const a = b => {
                                if ("text2" !== (null === b || void 0 === b ? void 0 : b.type)) throw new c4("text2", b);
                                return b.value
                            };
                            return {
                                zk: b => ({
                                ...
                                Os: b => {
                                    if ("text2" !== (null === b || void 0 === b ? void 0 : b.type)) throw new d4("text2", b);
                                    return b.value
                                },
                                Ns: a,
                                Lu: a
                    ...
                    bNb = j4({
                        ...
                        border: ["b", function() {
                            const a = b => {
                                if ("stroke" !== (null === b || void 0 === b ? void 0 : b.type)) throw new c4("stroke", b);
                                return b.value
                            };
                            return {
                                zk: b =>
                                ...
                                Os: b => {
                                    if ("stroke" !== (null === b || void 0 === b ? void 0 : b.type)) throw new d4("stroke", b);
                                    return b.value
                                },
                                Ns: a,
                                Lu: a
                        ...
                        boa: ["hh", function(a) {
                            const b = (c, d) => {
                                if (null == c) return a;
                                if ("boolean" !== (null === c || void 0 === c ? void 0 : c.type)) throw "toWidgetData" === d ? new c4("boolean", c) : new d4("boolean", c);
                                return c.value
                            };
                            return {
                                zk: c => ({
                ...
                var xMb = 9 * __c.FU,
                    ...
                    BMb = ["#ffae00", "#ffc654"],
                    CMb = ["#545454", "#c8c8c8"];
                var A4 = (a, b, c, d, e) => __c.Aj.Nc().attrs({
                    "font-size": B4,
                    leading: void 0,
                    "text-align": "center",
                    direction: z4(c),
                ...
                __c.fKa = {
                    I0a: function(a, b, c, d, e, f, g, h, k) {
                        ...
                        const {
                            Ysb: l
                        } = null !== d && void 0 !== d ? d : {}, m = h.wy("ui.rendering.form"), n = {
                            root: new NMb,
                            option: new NMb
                        }, p = new gNb(b);
                        return {
                                ...
                                if (l && a) {
                                    var r, t = PMb(() => q.Xe.id, () => {
                                            ...
                                            y.Hsb({
                                                ...
                                                if (z.ok && z.value) {
                                                    z = z.value;
                                                    var C, F = null !== (C = null === (A = q.Xe.fields.first()) || void 0 === A ? void 0 : A.value.id) && void 0 !== C ? C : "",
                                                        H;
                                                    ({
                                                        lf: A
                                                    } = null !== (H = z.Qmb.get(F)) && void 0 !== H ? H : {});
                                                    H = new Map(q.Hm.Wz);
                                                    var I;
                                                    H.set(v, { ...(null !== (I = H.get(v)) && void 0 !== I ? I : n4),
                                                        lf: A,
                                                        bK: A
                                                    });
                                                    q.Ul({
                                            ...
                                            y.getSettings({
                                                ...
                                                let A = z;
                                                if (3 !== z.status && !q.Xe.Cda && "quiz" === q.Xe.type) {
                                                    var C, F;
                                                    const H = null !== (F = null === (C = q.Xe.fields.first()) ||
                                                        void 0 === C ? void 0 : C.value.QX.toArray()) && void 0 !== F ? F : [];
                                                    A = {
                                                        status: 1,
                                                        wub: I => H.includes(I)
                                                    }
                                        ...
                                        u = PMb(() => 2 === (null === k || void 0 === k ? void 0 : k.status), OMb(v => {
                                            q.Ul({
                                                sj: v
                                            })
                                        }), {
                                ...
                                a: {
                                    ...
                                    switch (v.type) {
                                        case "poll":
                                            ...
                                            var A = y.cPa,
                                                C = r.direction,
                                                F = null === (z = r.fields.first()) || void 0 === z ? void 0 : z.value;
                                            if (F && v && x) {
                                                z = w4(v);
                                                var H = w4(x),
                                                    I = t.jna(),
                                        ...
                                        case "quiz":
                                            ...
                                            x = y.cPa;
                                            A = z.direction;
                                            var L = null === (C = z.fields.first()) || void 0 === C ? void 0 : C.value;
                                            if (L && J && v) {
                                                C = w4(J);
                                                F = w4(v);
                                                H = t.sS();
