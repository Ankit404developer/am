            ...
            (function(__c) {
                ...
                var PPb = function(a, b, c, d) {
                    ...
                    J5 = function(a) {
                        var b;
                        const c = { ...__c.wx,
                            Pa: null !== (b = null === a || void 0 === a ? void 0 : a.Pa) && void 0 !== b ? b : 0
                        };
                    ...
                    bQb = function(a, b) {
                        ...
                        XPb(a.cells, c, (e, f) => {
                            ...
                            g || (N5(e.fill, f.fill), ZPb(e.border, f.border), $Pb(e.V, f.V))
                        }, e => M5(e));
                        aQb(a.behavior, b, c);
                        N5(a.fill, b.fill);
                        $Pb(a.V, b.V);
                    ...
                    aQb = function(a, b, c) {
                        O5(a.rules, [b], d => {
                            cQb(d.grid.gridTemplateColumns, b.gridTemplateColumns) || (d.grid.gridTemplateColumns =
                                b.gridTemplateColumns);
                            cQb(d.grid.gridTemplateRows, b.gridTemplateRows) || (d.grid.gridTemplateRows = b.gridTemplateRows);
                            var e;
                            ...
                            XPb(d.grid.Rg, c, (g, h) => {
                                ...
                                g.gridRowEnd = n;
                                "number" === typeof k &&
                                    g.padding.all !== k ? g.padding.all = k : "number" !== typeof k && (g.padding.Aa = null === k || void 0 === k ? void 0 : k.Aa, g.padding.La = null === k || void 0 === k ? void 0 : k.La, g.padding.za = null === k || void 0 === k ? void 0 : k.za, g.padding.Sa = null === k || void 0 === k ? void 0 : k.Sa);
                                g.alignSelf = p
                            }, g => VPb(g))
                        }, d => {
                            var e, f;
                    ...
                    dQb = function(a,
                        ...
                        O5(a.yb, b.yb, (e, f) => {
                            e.d = f.d;
                            N5(e.fill, f.fill);
                            e.stroke.ref && f.stroke ? (e = e.stroke.ref, f = f.stroke, e.color = f.color, e.weight = f.weight) : e.stroke.set(WPb(f.stroke))
                        }, e => QPb(e));
                        const {
                            viewBox: c,
                            width: d
                    ...
                    YPb = function(a, b, c) {
                        switch (b.type) {
                            case "shape":
                                ...
                                break;
                            case "text":
                                "text" === a.type && __c.Aj.domain.Ub(__c.Aj.ra(a.text), SPb(b).text) || c();
                                break;
                            case "layout":
                    ...
                    ZPb = function(a, b) {
                        b = K5(b).all;
                        var c;
                        if (c = b) c = a.all.ref, c = !(c && b ? __c.jF.domain.Ub(__c.jF.ra(c), b) : !c && !b);
                        c && a.all.set(b)
                    },
                    cQb = function(a, b) {
                    ...
                    hQb = function(a, b, c, d, e) {
                        ...
                        const h = e.Px,
                            ...
                            m = e.MKa;
                        c = __c.MQ.ra(c);
                        const n = (null === (f = (g = a.jA).BGa) || void 0 === f ? void 0 : f.call(g, d)) || __c.YV;
                        h.Hm === k && gQb.structural(c, l) && n.mode === m || (e.BAa = c, e.WJa = h.Hm, e.MKa = n.mode, b = b.render(h, n), a.X$a.update(d, b), PPb(d, b, (p, q) => a.hP.Koa.set(p, q), (p, q, r) => a.hP.refs.set(p, {
                            ref: q,
                            key: r
                        })))
                    },
                    ...
                    lQb = function(a, b) {
                        return {
                            kR: ({
                                ...
                                const {
                                    Px: e
                                } = fQb(a.renderer, c, b, a.f0), f = __c.OQ.create([]), g = [];
                                g.push(kQb(a.H4a, f));
                                g.push(iQb(() => {
                                        var k, l;
                                        return [null === (k = (l = a.jA).BGa) || void 0 === k ? void 0 : k.call(l, f), __c.MQ.ra(c), e.Hm]
                                    },
                                    () => {
                                        hQb(a.renderer, b, c, f, a.f0)
                                    }, {
                                        fireImmediately: !0,
                                        equals: gQb.structural
                                    }));
                                const h = null === (d = b.Xqa) || void 0 === d ? void 0 : d.call(b, {
                                    Px: e
                                });
                                h && g.push(h);
                                return {
                ...
                var rQb = class {
                    ...
                    eQb = class {
                        ...
                        Ul(a) {
                            this.XJa.set(a instanceof Function ? { ...this.Hm,
                                ...a()
                            } : { ...this.Hm,
                                ...a
                            })
                ...
                var sQb = class {
                    constructor(a) {
                        ...
                        this.update = (b, c) => {
                            ...
                            for (const d of b) B("layout" === d.type), d.width = c.minWidth, d.height = c.minHeight, d.F = c.minWidth, d.P = c.minHeight, c.direction && (d.direction = c.direction), this.Bj.Lca(d)
                        }
                    }
                };
                var tQb = class {
                ...
                var uQb = class {
                        ...
                        constructor(a, b) {
                            ...
                            this.Kma = new Set;
                            this.Gab = () => {
                                this.b9 || (this.b9 = __c.Hua(this.jc).subscribe(d => {
                                    pQb(() => {
                                        this.Fpa.add(d.id)
                                    })
                                }));
                                ...
                                return () => {
                                    this.Kma.delete(c);
                                    0 >= this.Kma.size && this.b9 && (this.b9.unsubscribe(), this.b9 = void 0)
                                }
                            }
                        }
                    },
                    jQb = class extends __c.zD {
                        ...
                        oP(a) {
                            this.zma = (a = a.text.qy("font-family")["font-family"].values().next().value) &&
                                __c.oB(a).id
                        }
                    };
                var vQb = !1,
                    wQb = class {
                        register(a, b) {
                            this.RD.has(a) || (this.RD.set(a, b), vQb || (__c.NQ.set(a, lQb(this, b)), vQb = !0))
                        }
                        get(a) {
                ...
                var xQb = class {
                    delete(a) {
                        ...
                        c && (null === (b = this.C5.get(a)) || void 0 === b ? void 0 : b.reportChanged());
                        return c
                    }
                    get(a) {
                        nQb(this, a);
                    ...
                    set(a, b) {
                        if (!this.map.has(a) || this.map.get(a) !== b) {
                            var c;
                            this.map.set(a, b);
                            null === (c = this.C5.get(a)) || void 0 === c ? void 0 : c.reportChanged()
                        }
                        return this
                    }
                    constructor() {
